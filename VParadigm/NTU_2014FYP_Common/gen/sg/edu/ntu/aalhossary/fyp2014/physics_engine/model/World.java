...
import sg.edu.ntu.aalhossary.fyp2014.physics_engine.model.Units.*;
...
//	@Option(name = "-l", aliases = "-level", usage = "Simulation Level")
	...
	public static int frameTime_as = 500;
...
//			
//			i++;
//			if(i > 10_000 && simulationLvlAtomic || i>20_000 && !simulationLvlAtomic) {
...
//	}
	...
	private static void checkSimulationLevel(){
		...
		if(simulationLvlAtomic) {
			...
			if(simulationLvlPartial){
				octTree.clear();
				for(AbstractParticle particle: ((sg.edu.ntu.aalhossary.fyp2014.physics_engine.model.Molecule)allMolecules.get(0)).getAtoms()) {
					octTree.insert(particle);
				}
